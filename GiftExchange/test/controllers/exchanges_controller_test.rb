...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { Date: @exchange.Date, Deadline: @exchange.Deadline, Description: @exchange.Description, name: @exchange.name, user_id: @exchange.user_id }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { Date: @exchange.Date, Deadline: @exchange.Deadline, Description: @exchange.Description, name: @exchange.name, user_id: @exchange.user_id }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
